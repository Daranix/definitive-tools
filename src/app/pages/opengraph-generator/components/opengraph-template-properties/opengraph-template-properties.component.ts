...
import {
  ...
  GradientDirection,
  TemplateType,
  BACKGROUND_OVERLAY_PATTERNS_VIEW,
  BACKGROUND_OVERLAY_COLORS,
} from '../../constants';
import { FormsModule } from '@angular/forms';
import { FONT_TYPES } from '../opengraph-font-options/opengraph-font-options.component';
import {
  OpenGraphBackgroundGradient,
  OpenGraphBackgroundImage,
  OpenGraphBackgroundOverlay,
  OpenGraphBackgroundSolid,
  OpenGraphData,
} from '../../types';
...
@Component({
  ...
  imports: [
    ...
    NgStyle,
    FormsModule,
    OpengraphTemplateFormComponent,
    ContextMenuDirective,
    OpengraphBackgroundOverlayOptionsComponent,
...
export class OpengraphTemplatePropertiesComponent {
  ...
  readonly backgroundImageUrl = signal<{
    url?: string;
  ...
  readonly backgroundColorSelected = signal<string | string[]>(
    GRADIENT_COMBINATIONS[0],
  );
  readonly gradientDirectionSelected = signal<GradientDirection>(
