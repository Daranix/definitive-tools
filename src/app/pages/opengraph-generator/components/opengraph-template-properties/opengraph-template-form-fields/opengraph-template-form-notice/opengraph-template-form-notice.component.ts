...
import {
  OpenGraphImage,
  OpenGraphTemplateBasic,
  OpenGraphTemplateFormInputFontOptions,
  OpenGraphTemplateNotice,
...
export class OpengraphTemplateFormNoticeComponent {
  ...
  readonly descriptionFontOptions =
    model<OpenGraphTemplateFormInputFontOptions>(
      DESCRIPTION_DEFAULT_FONT_OPTIONS,
    );
